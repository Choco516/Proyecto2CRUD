...
<style>
  body { 
    background: url(http://www.firsthdwallpapers.com/uploads/2013/07/dubstep-free-ipad-color-wave-hd-eu-282954.jpg) no-repeat center center fixed; 
...
<?php
        ...
        foreach ($data as $row) {            
          ...
          echo '<img src="http://embamex.sre.gob.mx/honduras/images/stories/icono-boletin.png" class="img-circle">';
          echo '</div>';
          ...
          echo '<li><a href="' . base_url() . 'Administrativos/Editar/' . $row['Cédula'] . '"><span class="icon-wrench"></span> Modificar</a></li>';
          echo '<li><a href="' . base_url() . 'Administrativos/EliminarAdministrativos/' . $row['Cédula'] . '"><span class="icon-trash"></span> Eliminar</a></li>';
          echo '</ul>';
          echo '</div>';
          echo '</div>';
          echo '</div>';
