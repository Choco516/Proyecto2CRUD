    ...
    <div class="container">
      ...
      <?php
        ...
        foreach ($data as $row) {            
            ...
            echo '                    <li><a href="' . base_url() . 'Administrativos/Editar/' . $row['Cédula'] . '"><span class="icon-wrench"></span> Editar</a></li>';
            echo '                    <li><a href="' . base_url() . 'Administrativos/Eliminar/' . $row['Cédula'] . '"><span class="icon-trash"></span> Eliminar</a></li>';
            echo '                </ul>';
            echo '            </div>';
