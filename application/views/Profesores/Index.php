...
<style>
  body { 
    background: url(http://fc08.deviantart.net/fs51/f/2009/267/9/b/HD_Color_Blur_by_Luftherz.jpg) no-repeat center center fixed; 
    ...
    <div class="container">
      ...
      <?php
        ...
        foreach ($data as $row) {            
          ...
          echo '<img src="http://www.upci.edu.pe/img/LC_Icono_02_128.png" class="img-circle">';
          echo '</div>';
          ...
          echo '<li><a href="' . base_url() . 'Profesores/Editar/' . $row['Cédula'] . '"><span class="icon-wrench"></span> Modificar</a></li>';
          echo '<li><a href="' . base_url() . 'Profesores/EliminarProfesores/' . $row['Cédula'] . '"><span class="icon-trash"></span> Eliminar</a></li>';
          echo '</ul>';
          echo '</div>';
          echo '</div>';
          echo '</div>';
