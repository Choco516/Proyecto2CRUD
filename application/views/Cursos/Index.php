    ...
    <div class="container">
      ...
      <?php
        ...
        foreach ($data as $row) {            
            ...
            echo '                    <li><a href="' . base_url() . 'Cursos/Editar/' . $row['Id_Curso'] . '"><span class="icon-wrench"></span> Editar</a></li>';
            echo '                    <li><a href="' . base_url() . 'Cursos/Eliminar/' . $row['Id_Curso'] . '"><span class="icon-trash"></span> Eliminar</a></li>';
            echo '                </ul>';
            echo '            </div>';
            echo '            <div class="media-body"> ';
            echo '                <h4 class="margin-base-vertical">' . $row['Id_Curso'] . ' <small></h4> ';
            echo '                <span class="label label-default">' . $row['Carrera'] . '</span> ';
            echo '            </div>';
            echo '          </div>';
            echo '        </div>';
            echo '        <!-- //main content -->';
