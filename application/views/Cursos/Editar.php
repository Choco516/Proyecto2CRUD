    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-md-offset-3 panel panel-default">
          ...
          <form class="form-horizontal" action="<?php echo base_url();?>Cursos/EditarCursos" method="Post">
            ...
            <fie1ldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="id_curso" name="id_curso" type="text" placeholder="Id Curso" class="input-xlarge" value="<?php echo $data->Id_Curso; ?>">
                  <p class="help-block">
                  </p>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  class="input-xlarge" value="<?php echo $data->Carrera; ?>">
                  <p class="help-block">
                  </p>
                </div>
              </div>
