...
<?php
        ...
        foreach ($data as $row) {            
          ...
          echo '<li><a href="' . base_url() . 'Aulas/Editar/' . $row['Codigo'] . '"><span class="icon-wrench"></span> Modificar</a></li>';
          echo '<li><a href="' . base_url() . 'Aulas/EliminarAulas/' . $row['Codigo'] . '"><span class="icon-trash"></span> Eliminar</a></li>';
          echo '</ul>';
          echo '</div>';
          echo '</div>';
          echo '</div>';
