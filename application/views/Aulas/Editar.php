    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-md-offset-3 panel panel-default">
          ...
          <form class="form-horizontal" action="<?php echo base_url();?>aulas/EditarAulas" method="Post">
            ...
            <fie1ldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="codigo" name="codigo" type="text" placeholder="Codigo" class="input-xlarge" value="<?php echo $data->Codigo; ?>">
                  <p class="help-block">
                  </p>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="ubicacion" name="ubicacion" type="text" placeholder="Ubicación"
                  class="input-xlarge" value="<?php echo $data->Ubicación; ?>">
                  <p class="help-block">
                  </p>
                </div>
              </div>
